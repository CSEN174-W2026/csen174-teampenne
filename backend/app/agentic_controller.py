...
def main():
    # Create a node client instance with a timeout of 2 seconds
    ...
    while True:
        ...
        # Call discover_nodes to find available nodes --> each node is a NodeSnapshot object
        ...
        for n in nodes:
            try:
                # Get metrics for each node using the client
